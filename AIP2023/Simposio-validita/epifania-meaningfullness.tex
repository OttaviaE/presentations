...
\section{Real data application}
	...
	Both scoring are based on the discretization of the response times  $\rightarrow$ There should not be differences in the \textbf{order} of the total score of the respondents according to the scoring method 
	...
	\begin{figure}
	\centering
	\includegraphics[width=.50\linewidth]{img/exp.pdf}
	\end{figure}
