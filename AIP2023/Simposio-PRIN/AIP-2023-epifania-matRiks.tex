...
\title{mat\texttt{R}iks: \\ An \texttt{R} package for the automatic generation of Raven-like matrices}
\author{\textbf{Ottavia M. Epifania}, \textbf{Andrea Brancaccio}, Debora de Chiusole, Pasquale Anselmi, Luca Stefanutti}
...
FISPPA Department,\\ University of Padova}
	...
	\date [AIP2023] {%\vspace{0.6cm}\\
		 AIP-Sezione Sperimentale Conference 2023\\Symposium: New frontiers for the adaptive assessment of executive functions\\ \vspace{3mm}
		18\textsuperscript{th} September 2023}
\begin{document}
...
\begin{frame}
	...
	Only once in a lifetime (or after  a very looooooong time)
	\end{alertblock}
%	\pause
...
\cellcolor{difference!70}	\includegraphics[width=.4\linewidth]{img/difference.pdf} & \cellcolor{white}\\
\end{tabular}
}
		};
...
\includegraphics[width=.65\linewidth]{img/icc.pdf}
\end{figure}
...
\begin{frame}
	\begin{itemize}
				\item Formalization of the matrix generation process $\rightarrow$ Modulate the stimulus difficulty by varying its elements 
	...
	\begin{figure}
	\includegraphics[width=.30\linewidth]{img/theMatrix_real.jpg}
	\end{figure}
...
\begin{frame}[plain]
			...
			\vspace{3mm}
			\includegraphics[width=.4\linewidth]{img/matriks.png}
	...
	ottavia.epifania@unipd.it
		...
		\begin{textblock*}{2cm}(11.5cm,7cm)
