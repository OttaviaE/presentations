...
\author{\textbf{Ottavia M. Epifania}, Andrea Brancaccio, Debora de Chiusole, Pasquale Anselmi, Luca Stefanutti}
\institute{Department of Philosophy, Sociology, Education and Applied Psychology, \\University of Padova, IT}
\date{Symposium: New frontiers for the adaptive assessment of executive functions

and fluid intelligence\\ Conference of the Italian Association of Psychology, \\ Lucca, September 2023}
\titlegraphic{%
...
\begin{frame}{An example: The matrix}
	...
	\imagegrid{10}{\tiny}{1}	
		...
		\highlightbox[red,very thick]{0.18}{0.1}{0.36}{0.9}{red}{}{3}
			\highlightbox[red,very thick]{0.40}{0.1}{0.59}{0.9}{red}{}{3}
...
\begin{frame}
	...
	\begin{tabular}{p{2cm}p{4cm} p{8cm}}
		...
		& Diagonal & The objects are modified horizontally and diagonally\\ 
	\end{tabular}}
\end{frame}
