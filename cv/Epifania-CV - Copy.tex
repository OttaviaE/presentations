...
\begin{description}
	...
	\item[] Brancaccio, A., Epifania, O.M., \& de Chiusole, D. (2023). \texttt{matRiks}: Generates Raven-Like Matrices According to Rules [Computer software manual]. R package version 0.1.0. Retrieved from \href{https://cran.r-project.org/web/packages/matRiks/index.html}{thttps://cran.r-project.org/web/packages/matRiks/index.html}
