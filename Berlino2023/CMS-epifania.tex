...
\includegraphics[width=1.5cm,height=1.5cm,keepaspectratio]{img/unicatt.png}\\ 
	\textsuperscript{1} University of Padova, Padova (IT)\\ \textsuperscript{2} Psicostat Group, University of Padova, Padova (IT) \\ \textsuperscript{3} Università Cattolica del Sacro Cuore, Milano (IT)}

\date [CMStatistics 2023] {%\vspace{0.6cm}\\
	\small
	Computational and Methodological Statistics\\ Berlin, Germany \\ \vspace{3mm}
...
\begin{frame}
	...
	\begin{block}{Respondents are random factors}
...
\vspace{3mm}
\pause
\begin{block}{Stimuli/items are fixed factors}
