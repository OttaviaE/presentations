...
author: "Ottavia M. Epifania & Livio Finos"
format: 
  revealjs: 
    theme: mytheme.scss
...
## The 4-Parameters Logistic Model (4-PL)
...
plot(theta, IRT(theta, a = 1.5, b = 0), 
     ...
     cex.axis =1.5, xlab = expression(theta), lwd = 3, col = "seagreen", main = "Item Response Function")
...
$d$ depends on the rank $r$ of item in the administration: 
...
![](www/mia_animazione.gif){style="display: block; margin-left: auto; margin-right: auto;"}
