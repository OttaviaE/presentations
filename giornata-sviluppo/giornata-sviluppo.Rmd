...
header-includes: 
  ...
  - \AtBeginDocument{\date[]{European Meeting of the Matemathical Psychology Group}}
...
\centering 
\Large
Regole generative che vengono utilizzate per manipolare i rapporti visuo-spaziali o logici tra figure e oggetti
...
Time has passed... but few open and easy-to-use resources are available for the generation of Raven's like matrices


\begin{block}{Corvus}

It's on \href{GitHub}{https://github.com/Thimbleby/Corvus} (and the maintainer is super nice :)!

Based in Javascript but provided with with an intuitive UI
...
They don't allow for reproducing the stimuli generation process
...
my_responses = response_list(the_mat)
...
Il codice rimane e si può inserire all'interno di un RMarkdown per avere stimoli e distrattori sempre insieme 
