...
institute: "$^1$ Psicostat, Padova $^2$ University of Trento, Rovereto"
date: today
format: 
  revealjs: 
    theme: mytheme.scss
...
#| out-width: 50%
library(knitr)
include_graphics("img/TIF-target.png")
```
...
#| out-width: 50%
library(knitr)
include_graphics("img/TIF-first.png")
```
...
#| out-width: 50%
library(knitr)
include_graphics("img/TIF-second.png")
```
...
#| out-width: 50%
library(knitr)
include_graphics("img/TIF-third.png")
```
