...
\begin{frame}{The struggle}
	
	Rule of thumb $\rightarrow$  more questions more reliability 
	
	Drawback $\rightarrow$ too many questions, too many questionnaire $\rightarrow$ assessment precision might be compromised by the length of the assessment 
	
	Esempio che mi manda Andrea per l'indagine dei giovani, tantissimi quetsionari, indagine lunghissima 
	
	
	\begin{center}
		\large \textcolor{template}{The Ideal Solution}
	\end{center}
	
	A short test form (STF) as informative as the full-length test
