...
\begin{frame}{An example}
	...
	\begin{tikzpicture}
		...
		\highlightbox[green,very thick]{0.03}{0.01}{0.98}{0.45}{red}{}{3}
	\end{tikzpicture}
...
\small 
	...
	\scalebox{.90}{
		...
		\onslide<3->\textcolor{repetition}{Repetition} & \onslide<3-> Repetition of a cell \textbf{adjacent} to the blank space \\ 
		\onslide<4->\textcolor{difference}{Difference} & \onslide<4-> Different in appearance from every element of the matrix\\
		\onslide<5->\textcolor{wp}{Wrong Principle} & \onslide<5-> Copy of a cell or combination of cells \\
		\onslide<6->\textcolor{ic}{Incomplete Correlate} & \onslide<6-> \textbf{Almost} the correct response \\
