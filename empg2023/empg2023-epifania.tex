...
\usetikzlibrary{mindmap,calc,patterns,decorations.pathmorphing,decorations.markings, arrows, shapes.arrows, shapes, backgrounds,positioning,shadows.blur, positioning, fit, shadows}
...
\definecolor{background}{RGB}{253, 253, 253}
\setbeamercolor{frametitle}{bg=background}
\setbeamercolor{section in toc}{fg=template}
\setbeamercolor{subsection in toc}{fg=black}
\setbeamerfont{section in toc}{size=\normalsize}
\setbeamertemplate{frametitle}{\color{myGreen}\bfseries\scshape\insertframetitle\par\vskip2pt\hrulefill}
...
\setbeamercolor{section in head/foot}{bg=background, fg=myGreen}
...
\author{Ottavia M. Epifania, Andrea Brancaccio, Debora de Chiusole, Pasquale Anselmi, Luca Stefanutti}
\institute{University of Padova, IT}
\date{MathPsych, ICCM, EMPG, July 2023}
\titlegraphic{%
...
\begin{frame}{}
		...
		\onslide<2->
		%			\node[startstop] at (0, 0)   (start) {Response options generator};
		\node[startstop] at (0, 0)   (start) {\texttt{response\_list()}};
		\onslide<1->
		\node (matrix) [rectangle ,above of = start, yshift = 1.5] {%
...
\begin{frame}
	\begin{itemize}
				\item Formalization of the matrix generation 
